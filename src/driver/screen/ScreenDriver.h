...
public:
    void begin();
    void update(uint8_t brightness, uint16_t backgroundColor);
    ...
    void drawTriangle(int16_t BaseX, int16_t BaseY, int16_t TargetX, int16_t TargetY, int16_t AngleRatio, uint16_t backgroundColor, uint16_t BorderSize, uint16_t BorderColor);
};